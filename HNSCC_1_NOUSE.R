...
e<-paste("HNSCC_",1,"_PBMC",sep="")

for (i in 2:26) {
  f<-paste("HNSCC_",i,"_PBMC",sep="") 
  e<-paste(e,f,sep = ", ")
}
...
immune.PBMC <- FindIntegrationAnchors(object.list = list(HNSCC_1_PBMC, HNSCC_2_PBMC, HNSCC_3_PBMC, HNSCC_4_PBMC, HNSCC_5_PBMC, HNSCC_6_PBMC, HNSCC_7_PBMC, HNSCC_8_PBMC, HNSCC_9_PBMC, HNSCC_10_PBMC, HNSCC_11_PBMC, HNSCC_12_PBMC, HNSCC_13_PBMC, HNSCC_14_PBMC, HNSCC_15_PBMC, HNSCC_16_PBMC, HNSCC_17_PBMC, HNSCC_18_PBMC, HNSCC_19_PBMC, HNSCC_20_PBMC, HNSCC_21_PBMC, HNSCC_22_PBMC, HNSCC_23_PBMC, HNSCC_24_PBMC, HNSCC_25_PBMC, HNSCC_26_PBMC), dims = 1:50,anchor.features = 10000)
immune.combined_PBMC <- IntegrateData(anchorset = immune.PBMC)

immune.TIL <- FindIntegrationAnchors(object.list = list(HNSCC_1_TIL, HNSCC_2_TIL, HNSCC_3_TIL, HNSCC_4_TIL, HNSCC_5_TIL, HNSCC_6_TIL, HNSCC_7_TIL, HNSCC_8_TIL, HNSCC_9_TIL, HNSCC_10_TIL, HNSCC_11_TIL, HNSCC_12_TIL, HNSCC_13_TIL, HNSCC_14_TIL, HNSCC_15_TIL, HNSCC_16_TIL, HNSCC_17_TIL, HNSCC_18_TIL, HNSCC_19_TIL, HNSCC_20_TIL, HNSCC_21_TIL, HNSCC_22_TIL, HNSCC_23_TIL, HNSCC_24_TIL, HNSCC_25_TIL, HNSCC_26_TIL), dims = 1:50,anchor.features = 10000)
immune.combined_TIL <- IntegrateData(anchorset = immune.TIL)
